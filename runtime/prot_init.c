...
#define PROT_MAGIC_RAW  0x544F5250
#define PROT_MAGIC      (PROT_MAGIC_RAW^0xC01EBA42)
#define PROT_MAGIC_XOR  PROT_MAGIC_RAW
#define STRTBL_MAGIC    0x52545354
#define INTEG_MAGIC     0x9740B255
#define CRIT_MAGIC      0x54495243
#define WLIST_MAGIC     0x54534C57
#define STR_HASH_SEED   0xE00CB63A
#define PAGE_SZ         4096
