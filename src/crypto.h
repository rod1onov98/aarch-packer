...
struct XorShift64{
    uint64_t s;
    XorShift64(uint64_t seed):s(seed?seed:0xdeadbeefcafe1337){}
...
static inline std::string garbage_sym_name(uint64_t s){XorShift64 r(s^0xA5A5A5A5A5A5A5A5);int l=32+(r.next32()%96);return"_Z"+r.name(l);}
