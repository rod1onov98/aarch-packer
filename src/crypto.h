...
// Third shares — MUST match TK_C/CK_C/TN_C/CN_C in runtime/prot_init.c byte-for-byte.
...
// 3-share KDF, byte-identical to kdf_key/kdf_nonce in runtime/prot_init.c.
