...
inline void write_arm32_stub_pcrel(uint8_t* p, uint32_t stub_va, uint32_t target, bool thumb) {
    uint32_t ldr = 0xE59FC004; // LDR  r12,[pc,#4]
    uint32_t add = 0xE08FC00C; // ADD  r12,pc,r12
    uint32_t bx = 0xE12FFF1C; // BX   r12
